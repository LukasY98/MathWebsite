...
<body>
    ...
    <div id="main-wrapper" class="bg-light">
        <main class="container">
            ...
            <p>Max Mustermann<br>Musterstraße 1<br>26340, Zetel, Deutschland</p>
            <p><strong>E-Mail-Adresse:</strong> <a href="mailto:max.mustermann@mail.de">max.mustermann@mail.de</a></p>
